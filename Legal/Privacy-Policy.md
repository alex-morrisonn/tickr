...
Tickr stores app preferences in `UserDefaults` on your device.

Tickr may store a cached calendar response in the app’s cache directory to reduce repeated downloads and improve load performance. Cached files can be cleared from the app’s settings.
...
Preferences remain on-device until you change them, reset the app, or remove the app.

Cached market calendar files remain on-device until they expire, are replaced, are cleared from settings, or the app is deleted.
...
- Change or reset in-app preferences.
- Clear cached calendar data from the settings screen.
- Delete the app to remove locally stored app data from your device.

## Children’s Privacy

Tickr is not directed to children under 13, and this app is not intended to knowingly collect personal information from children.
...
Privacy questions and requests: `privacy@tickr.app`

General support: `feedback@tickr.app`
